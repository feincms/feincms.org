...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_library_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ordering', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal('app_library', ['Category'])

        # Adding model 'CategoryTranslation'
        db.create_table('app_library_categorytranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['app_library.Category'])),
        ...
        db.send_create_signal('app_library', ['CategoryTranslation'])

    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table('app_library_category')

        # Deleting model 'CategoryTranslation'
        db.delete_table('app_library_categorytranslation')
