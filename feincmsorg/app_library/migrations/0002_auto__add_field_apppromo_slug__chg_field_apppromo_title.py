...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppPromo.slug'
        db.add_column('app_library_apppromo', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=None, unique=True, max_length=50),
                      keep_default=False)


        # Changing field 'AppPromo.title'
        db.alter_column('app_library_apppromo', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))
    def backwards(self, orm):
        # Deleting field 'AppPromo.slug'
        db.delete_column('app_library_apppromo', 'slug')


        # Changing field 'AppPromo.title'
        db.alter_column('app_library_apppromo', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
    models = {
