...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field categories on 'AppPromo'
        db.create_table('app_library_apppromo_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('apppromo', models.ForeignKey(orm['app_library.apppromo'], null=False)),
            ('category', models.ForeignKey(orm['app_library.category'], null=False))
        ))
        db.create_unique('app_library_apppromo_categories', ['apppromo_id', 'category_id'])

    def backwards(self, orm):
        # Removing M2M table for field categories on 'AppPromo'
        db.delete_table('app_library_apppromo_categories')

    models = {
        'app_library.apppromo': {
            'Meta': {'ordering': "['-updated']", 'object_name': 'AppPromo'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['app_library.Category']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'app_library.categorytranslation': {
            'Meta': {'ordering': "['title']", 'object_name': 'CategoryTranslation'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '10'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'to': "orm['app_library.Category']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
